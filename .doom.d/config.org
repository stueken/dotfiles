...
depending on whether the current focus is private or employer-specific.
...
This supports moving tasks out of journals, inboxes, and temporary notes into
their final destination files.
...
- =C-c C-w=: standard Org refile
- =SPC m r=: Doom refile command
